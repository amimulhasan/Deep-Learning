...
Original file is located at
    https://colab.research.google.com/drive/1X1l-cHYZOBwFp2l834TeN7sqfDBQnIcY
"""
...
dataset_path = "/content/brain-tumor-classification-mri.zip"  # Change this if needed

with zipfile.ZipFile(dataset_path, 'r') as zip_ref:
    zip_ref.extractall("dataset")  # Extract to "dataset" folder

os.listdir("dataset")  # Check extracted files
